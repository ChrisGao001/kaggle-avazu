...
def hour_diff(a, b):
    ...
    greater_day = int(greater[:-2])
    greater_hour = int(greater[-2:])

    smaller_day = int(smaller[:-2])
    smaller_hour = int(smaller[-2:])

    return (greater_day-smaller_day)*24+(greater_hour-smaller_hour)
